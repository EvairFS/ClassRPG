...
function ActivityDetail() {
  ...
  // Sync textarea once activity loads
  if (!answer && activity.submission && !submit.isSuccess) {
    // best-effort init without effect; harmless on rerender
  }
